...
async function GET() {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('teams').select('*').limit(5);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c88da5c._.js.map