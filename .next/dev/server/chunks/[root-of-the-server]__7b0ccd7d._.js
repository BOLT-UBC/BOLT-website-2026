...
async function GET() {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id').limit(1);
        if (error) {
...
async function HEAD() {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id').limit(1);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b0ccd7d._.js.map