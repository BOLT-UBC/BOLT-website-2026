...
"[project]/app/api/account/delete/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request) {
    try {
        ...
        const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, email, role').eq('id', userId).single();
        ...
        if (profile.resume_url) {
            try {
                ...
                ;
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].storage.from('bolt-resumes-2025').remove([
                    `${userId}/${fileName}`
                ]);
            } catch (storageError) {
        ...
        const { error: deleteProfileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').delete().eq('id', userId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1884f9c8._.js.map