...
"[project]/app/test-profile/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TestProfilePage() {
    ...
    const runTest = async ()=>{
        ...
        try {
            ...
            const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', user.id).single();
            if (profileError) {
                if (profileError.code === 'PGRST116') {
                    ...
                    const { data: newProfile, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert(profileData).select().single();
                    if (createError) {
            ...
            const { data: allProfiles, error: allProfilesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id, email, role').limit(5);
            if (allProfilesError) {
...
_s(TestProfilePage, "GIez+Pf9BFPuCj8ANYavYzllfxg=", false, function() {
    return [
...
_c = TestProfilePage;
var _c;
__turbopack_context__.k.register(_c, "TestProfilePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f2fcce37._.js.map