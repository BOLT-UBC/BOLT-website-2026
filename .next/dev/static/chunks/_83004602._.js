...
;
function Button({ text, onClick, outline, type = 'button' }) {
...
"[project]/components/SpaceScene.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const SpaceScene = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = _s((_, ref)=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SpaceScene.useEffect": ()=>{
            ...
            const observerCallback = {
                "SpaceScene.useEffect.observerCallback": (entries)=>{
                    entries.forEach({
                        "SpaceScene.useEffect.observerCallback": (entry)=>{
                            isVisibleRef.current = entry.isIntersecting;
                        }
                    }["SpaceScene.useEffect.observerCallback"]);
                }
            }["SpaceScene.useEffect.observerCallback"];
            ...
            const cleanupObserver = {
                "SpaceScene.useEffect.cleanupObserver": ()=>{
                    if (currentMount) {
            ...
            const resizeCanvas = {
                "SpaceScene.useEffect.resizeCanvas": ()=>{
                            ...
                            if (nebulaClouds.length === 0) {
                                for(let i = 0; i < 3; i++){
                                    nebulaClouds.push({
                                        ...
                                        color: Math.random() < 0.5 ? '#7c3aed' : '#8b5cf6',
            ...
            const createExplosion = {
                "SpaceScene.useEffect.createExplosion": (clickX, clickY)=>{
                    ...
                    stars.forEach({
                        "SpaceScene.useEffect.createExplosion": (star)=>{
                    ...
                    }["SpaceScene.useEffect.createExplosion"]);
                }
            }["SpaceScene.useEffect.createExplosion"];
            // Spawn comet
            const spawnComet = {
                "SpaceScene.useEffect.spawnComet": ()=>{
                    if (Math.random() < 0.01) {
            ...
            const checkMeteorShower = {
                "SpaceScene.useEffect.checkMeteorShower": ()=>{
                    if (!meteorShowerActive && Math.random() < 0.0002) {
            ...
            }["SpaceScene.useEffect"], 100);
            window.addEventListener('resize', resizeCanvas);
            // Mouse tracking
            let mouseX = 0;
            let mouseY = 0;
            const handleMouseMove = {
                "SpaceScene.useEffect.handleMouseMove": (e)=>{
                    const rect = canvas.getBoundingClientRect();
                    mouseX = (e.clientX - rect.left) / rect.width;
                    mouseY = (e.clientY - rect.top) / rect.height;
                }
            }["SpaceScene.useEffect.handleMouseMove"];
            // Animation
            let animationId;
            const animate = {
                "SpaceScene.useEffect.animate": ()=>{
                    ...
                    nebulaClouds.forEach({
                        "SpaceScene.useEffect.animate": (cloud)=>{
                            cloud.x += cloud.drift;
                            // Wrap around
                    ...
                    comets.forEach({
                        "SpaceScene.useEffect.animate": (comet)=>{
                            comet.x += comet.vx;
                            comet.y += comet.vy;
                            comet.life++;
                            // Add to trail
                            ...
                            comet.trail.forEach({
                                "SpaceScene.useEffect.animate": (point, i)=>{
                    ...
                    explosions.forEach({
                        "SpaceScene.useEffect.animate": (explosion)=>{
                            explosion.particles.forEach({
                                "SpaceScene.useEffect.animate": (particle)=>{
                            ...
                            explosion.particles = explosion.particles.filter({
                                "SpaceScene.useEffect.animate": (p)=>p.life < p.maxLife
                            }["SpaceScene.useEffect.animate"]);
                        }
                    }["SpaceScene.useEffect.animate"]);
                    ...
                    stars.forEach({
                        "SpaceScene.useEffect.animate": (star)=>{
                            // Move stars
            ...
            const handleClick = {
                "SpaceScene.useEffect.handleClick": (e)=>{
                    createExplosion(e.clientX, e.clientY);
                }
            }["SpaceScene.useEffect.handleClick"];
            // Add event listeners
            canvas.addEventListener('mousemove', handleMouseMove);
            canvas.addEventListener('click', handleClick);
            // Expose createExplosion function globally for parent components
            if ("TURBOPACK compile-time truthy", 1) {
                window.spaceSceneExplosion = createExplosion;
            }
            // Start animation
            animate();
            // Cleanup
            return ({
                "SpaceScene.useEffect": ()=>{
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        delete window.spaceSceneExplosion;
                    }
                }
            })["SpaceScene.useEffect"];
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useImperativeHandle"])(ref, {
        "SpaceScene.useImperativeHandle": ()=>({
                createExplosion: ({
                    "SpaceScene.useImperativeHandle": (x, y)=>{
                        // This will be set up in useEffect
                        if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.spaceSceneExplosion) {
                            window.spaceSceneExplosion(x, y);
                        }
                    }
                })["SpaceScene.useImperativeHandle"]
            })
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/components/SpaceScene.tsx",
        lineNumber: 568,
        columnNumber: 5
    }, ("TURBOPACK compile-time value", void 0));
}, "xcsG81dNTDmhaXDgMLWxlIKrurc=")), "xcsG81dNTDmhaXDgMLWxlIKrurc=");
_c1 = SpaceScene;
const __TURBOPACK__default__export__ = SpaceScene;
var _c, _c1;
__turbopack_context__.k.register(_c, "SpaceScene$forwardRef");
__turbopack_context__.k.register(_c1, "SpaceScene");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const authService = {
    ...
    async updateProfile (userId, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update(updates).eq('id', userId).select().single();
        if (error) throw error;
        return data;
    },
    // Reset password
...
const Navbar = ()=>{
    ...
    const { user, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SpaceScene$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/SpaceScene.tsx [app-client] (ecmascript)");
...
const Hero = ()=>{
    _s();
    const spaceSceneRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SpaceScene$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ref: spaceSceneRef
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex justify-start items-center mt-8 lg:mt-0 relative z-30 w-full",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex flex-col justify-center items-start max-w-3xl p-4 md:p-6 gap-4 relative",
                    children: [
                        "+",
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: "font-inter text-6xl md:text-8xl font-bold text-white leading-tight drop-shadow-[0_0_20px_rgba(255,255,255,0.8)]",
                                    children: "BOLT"
                                }, void 0, false, {
                                    fileName: "[project]/components/Hero.tsx",
                                    lineNumber: 39,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "font-inter text-3xl md:text-5xl font-bold text-white leading-snug",
                            children: [
                                "UBC's ",
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-[#e879f9] uppercase",
                                    children: "Largest"
                                }, void 0, false, {
                                    fileName: "[project]/components/Hero.tsx",
                                    lineNumber: 53,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "font-inter text-sm md:text-base font-normal text-white/90 leading-relaxed max-w-2xl",
                            children: "Empowering UBC students to harness the power of data through hands-on workshops, case competitions, and networking events. Join us to develop practical analytics skills and connect with industry professionals."
                        }, void 0, false, {
                            fileName: "[project]/components/Hero.tsx",
                            lineNumber: 55,
                            columnNumber: 9
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    onClick: ()=>{
                                        if ("TURBOPACK compile-time truthy", 1) {
                                            window.open(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SITE_URLS"].membership, "_blank");
                                        }
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/components/Hero.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    onClick: ()=>{
                                        if ("TURBOPACK compile-time truthy", 1) {
                                            window.location.href = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SITE_URLS"].sponsorEmail;
                                        }
                                    },
                                    outline: true
                                }, void 0, false, {
...
_s(Hero, "7uumPSZB8AApdIXGfz2AJyNySZc=");
_c = Hero;
...
;
;
const Carousel = ({ images, interval = 4000, onImageLoad })=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Carousel.useEffect": ()=>{
            ...
            timerRef.current = window.setInterval({
                "Carousel.useEffect": ()=>{
                    setIndex({
                        "Carousel.useEffect": (i)=>(i + 1) % images.length
                    }["Carousel.useEffect"]);
                }
    ...
    return(// bigger responsive container: full width on small screens, capped on larger screens
    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative w-full max-w-[760px] sm:max-w-[640px] md:max-w-[800px] lg:max-w-[960px]",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Carousel, "+8Z7oo19IZa3cYxibHy6JluI+34=");
_c = Carousel;
const About = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(_c1 = ()=>{
    const images = [
        "/images/Byte.webp",
        "/images/Image1.webp",
        "/images/Image2.webp"
    ...
    // Optional: Could add loading state management here if needed
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col items-center justify-center bg-gradient-to-br from-[#f8f7f3] to-[#f0ede7] text-black text-left w-full py-20 md:py-24 px-6 sm:px-6 md:px-8 relative overflow-hidden",
        id: "About",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "font-inter text-sm md:text-base font-normal text-gray-600 mb-2 lowercase italic",
                            children: "About us"
                        }, void 0, false, {
                            fileName: "[project]/components/About.tsx",
                            lineNumber: 92,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            className: "font-inter text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-6 md:mb-8 leading-tight",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "font-inter text-sm leading-relaxed text-gray-800 mb-6 font-normal",
                                    children: [
                                        "Bolt provides an enriching platform that fosters collaboration, presents intellectually ",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "font-inter text-sm leading-relaxed text-gray-800 font-normal",
                                    children: [
                                        "Our mission is to ",
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                            className: "font-bold text-black",
...
__turbopack_context__.k.register(_c1, "About$memo");
...
const Partners = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(_c = ()=>{
    ...
    const partners = [
        {
            name: "UBC",
            logo: "/partners/ubc.webp"
        },
        {
            name: "Mastercard",
            logo: "/partners/mastercard.webp"
        },
        {
            name: "Red Bull",
            logo: "/partners/redbull.webp"
        },
        {
            name: "CGI",
            logo: "/partners/cgi.webp"
        },
        {
            name: "Microsoft",
        ...
        {
            name: "Deloitte",
            logo: "/partners/deloitte_logo.webp"
        }
    ];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "max-w-6xl w-full mx-auto px-6 sm:px-6 md:px-8 text-center mb-6 md:mb-8",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "font-inter text-xs sm:text-sm leading-relaxed opacity-90 text-white max-w-2xl mx-auto px-2 break-words",
...
var _c, _c1;
__turbopack_context__.k.register(_c, "Partners$memo");
...
"[project]/lib/events.json (json)", ((__turbopack_context__) => {

__turbopack_context__.v({"events":[{"name":"First Byte","image":"first-byte.webp"},{"name":"BOLT Connect","image":"bolt-connect.webp"},{"name":"BOLT Circuit","image":"bolt-circuit.webp"},{"name":"BOLT Bootcamp","image":"bootcamp.webp"}]});}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/lib/events.json (json)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
;
;
const eventsData = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2e$json__$28$json$29$__["default"];
const Events = ()=>{
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        id: "Events",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full max-w-6xl mx-auto px-6 sm:px-6 md:px-8",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-7",
                    children: EVENTS.slice(0, 4).map((event, index)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "w-56 h-56 overflow-hidden rounded-lg mb-2 mx-auto",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEventImageUrl"])(event.image),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-1.5 mt-4 mx-4 group-hover:text-gray-900 transition-colors duration-300",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            className: "font-inter text-gray-800 font-bold text-sm",
                                            children: event.name
                                        }, void 0, false, {
                                            fileName: "[project]/components/Events.tsx",
                                            lineNumber: 63,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "font-inter text-gray-700 text-xs leading-relaxed line-clamp-3",
                                            children: eventDescriptions[index]
                                        }, void 0, false, {
                                            fileName: "[project]/components/Events.tsx",
                                            lineNumber: 64,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: eventMonths[event.name]
                                            }, void 0, false, {
                                                fileName: "[project]/components/Events.tsx",
                                                lineNumber: 68,
                                                columnNumber: 19
...
"use client";
;
const Newsletter = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(_c = _s(()=>{
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "w-full py-16 md:py-16 flex items-center justify-center bg-gradient-to-r from-[#614ea5] to-[#493b7b]",
        id: "Newsletter",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "max-w-6xl mx-auto px-6 sm:px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "text-white text-left max-w-lg",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "font-inter text-sm font-normal mb-2 lowercase italic",
                            children: "Newsletter"
                        }, void 0, false, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            className: "font-inter text-2xl sm:text-3xl font-bold mb-4 md:mb-6 leading-tight",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "font-inter text-sm leading-relaxed opacity-90",
                            children: "Subscribe to our newsletter for exclusive updates on upcoming events, data analytics insights, workshops, and career opportunities in the tech industry."
                        }, void 0, false, {
                            fileName: "[project]/components/Newsletter.tsx",
                            lineNumber: 34,
                            columnNumber: 23
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-white/20 backdrop-blur-lg rounded-full p-2 shadow-lg flex items-center",
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: isLoading ? "Subscribing..." : isSubscribed ? "Subscribed!" : "Subscribe"
                                    }, void 0, false, {
                                        fileName: "[project]/components/Newsletter.tsx",
                                        lineNumber: 51,
                                        columnNumber: 15
                            ...
                            isSubscribed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "font-inter text-white text-sm mt-3 text-center opacity-90",
                                children: "Thank you for subscribing! Check your email for confirmation."
                            }, void 0, false, {
                                fileName: "[project]/components/Newsletter.tsx",
                                lineNumber: 60,
                                columnNumber: 15
...
}, "e1RqUzBlHtUY+A6UsQQdXlQsaEw=")), "e1RqUzBlHtUY+A6UsQQdXlQsaEw=");
_c1 = Newsletter;
Newsletter.displayName = 'Newsletter';
const __TURBOPACK__default__export__ = Newsletter;
var _c, _c1;
__turbopack_context__.k.register(_c, "Newsletter$memo");
...
__turbopack_context__.v({"teams":[{"team_name":"Leadership","executives":[{"name":"Nav Thukral","title":"President","profilepic":"NavThukral.webp","linkedin":"","personalEmail":"thukral.nav@boltubc.com","clubEmail":"president@boltubc.com"},{"name":"Eleanor Lam","title":"VP Ops & VP Case Dev","profilepic":"EleanorLam.webp","linkedin":"","personalEmail":"lam.eleanor@boltubc.com","clubEmail":"vpinternal@boltubc.com"},{"name":"Kiwi Mottahed","title":"VP Events","profilepic":"KiwiMottahed.webp","linkedin":"","personalEmail":"mottahed.kiwi@boltubc.com","clubEmail":"vpevents@boltubc.com"},{"name":"Aadeesh Nargotra","title":"VP CR","profilepic":"AadeeshNargotra.webp","linkedin":"","personalEmail":"nargotra.aadeesh@boltubc.com","clubEmail":"vpcr@boltubc.com"},{"name":"Raghav Awasthi","title":"VP Marketing","profilepic":"RaghavAwasthi.webp","linkedin":"","personalEmail":"awasthi.raghav@boltubc.com","clubEmail":"marketing@boltubc.com"},{"name":"Jessica Zhou","title":"VP Technology","profilepic":"JessicaZhou.webp","linkedin":"","personalEmail":"zhou.jessica@boltubc.com","clubEmail":"technology@boltubc.com"},{"name":"Chloe Lee","title":"VP Finance","profilepic":"ChloeLee.webp","linkedin":"","personalEmail":"lee.chloe@boltubc.com","clubEmail":"finance@boltubc.com"}]},{"team_name":"Advising","executives":[{"name":"Antarip Kashyap","title":"Advising Director","profilepic":"AntaripKashyap.webp","linkedin":""},{"name":"Bradley Wong","title":"Advising Director","profilepic":"BradleyWong.webp","linkedin":""},{"name":"Alexy Lamoot","title":"Advising Director","profilepic":"AlexyLamoot.webp","linkedin":""},{"name":"Kyle Gomez","title":"Advisor (Finance)","profilepic":"KyleGomez.webp","linkedin":""}]},{"team_name":"Community Relations","executives":[{"name":"Calista Budi","title":"CR Director","profilepic":"CalistaValencia.webp","linkedin":""},{"name":"Harshit Sethi","title":"CR Director","profilepic":"HarshitSethi.webp","linkedin":""},{"name":"Nevan Leo","title":"CR Executive","profilepic":"NevanLeo.webp","linkedin":""},{"name":"Ethan Le","title":"CR Executive","profilepic":"EthanLe.webp","linkedin":""},{"name":"Sophia Huang","title":"CR Executive","profilepic":"SophiaHuang.webp","linkedin":""},{"name":"Manya Garg","title":"CR Executive","profilepic":"ManyaGarg.webp","linkedin":""},{"name":"Kai Wu","title":"CR Executive","profilepic":"KaiWu.webp","linkedin":""}]},{"team_name":"Case Development","executives":[{"name":"Prashant Chopra","title":"Case Dev Executive","profilepic":"PrashantChopra.webp","linkedin":""},{"name":"Lucas Ho","title":"Case Dev Executive","profilepic":"LucasHo.webp","linkedin":""},{"name":"Ruhani Mittal","title":"Case Dev Executive","profilepic":"RuhaniMittal.webp","linkedin":""},{"name":"Arnav Dhablania","title":"Case Dev Executive","profilepic":"ArnavDhablania.webp","linkedin":""}]},{"team_name":"Events","executives":[{"name":"Aarav Alaric Bhatia","title":"Events Executive","profilepic":"AaravAlaricBhatia.webp","linkedin":""},{"name":"Hannah Goharian","title":"Events Executive","profilepic":"HannahGoharian.webp","linkedin":""},{"name":"Owen Chan","title":"Events Executive","profilepic":"OwenChan.webp","linkedin":""}]},{"team_name":"Marketing","executives":[{"name":"Leo Shang","title":"Marketing Executive","profilepic":"LeoShang.webp","linkedin":""},{"name":"Jove Wan","title":"Marketing Executive","profilepic":"JoveWan.webp","linkedin":""},{"name":"Divjot Virdi","title":"Marketing Executive","profilepic":"DivjotVirdi.webp","linkedin":""},{"name":"Anne Nguyen","title":"Marketing Executive","profilepic":"AnneNguyen.webp","linkedin":""},{"name":"Felicia Amelia","title":"Marketing Executive","profilepic":"FeliciaAmelia.webp","linkedin":""}]},{"team_name":"Development","executives":[{"name":"Chirag Raisingh","title":"Developer","profilepic":"ChiragRaisingh.webp","linkedin":""},{"name":"Chloe Sepulveda","title":"Developer","profilepic":"ChloeSepulveda.webp","linkedin":""},{"name":"Harmanjeet Singh","title":"Developer","profilepic":"HarmanjeetSingh.webp","linkedin":""}]},{"team_name":"Club Operations","executives":[{"name":"Nicole Li","title":"Club Ops Executive","profilepic":"NicoleLi.webp","linkedin":""},{"name":"Jacob O'Callaghan","title":"Club Ops Executive","profilepic":"JacobOCallaghan.webp","linkedin":""}]},{"team_name":"Finance","executives":[{"name":"Andrew Andrew","title":"Finance Executive","profilepic":"AndrewAndrew.webp","linkedin":""}]},{"team_name":"1st/2nd Year Representatives","executives":[{"name":"Natania Huang","title":"First Year Rep (CR)","profilepic":"NataniaHuang.webp","linkedin":""},{"name":"Julianna Huang","title":"First Year Rep","profilepic":"JuliannaHuang.webp","linkedin":""},{"name":"Carys Fong","title":"First Year Rep","profilepic":"CarysFong.webp","linkedin":""}]}],"pastExecutives":{"2025-2026":[{"name":"Nav Thukral","title":"President"},{"name":"Eleanor Lam","title":"VP Ops & VP Case Dev"},{"name":"Kiwi Mottahed","title":"VP Events"},{"name":"Aadeesh Nargotra","title":"VP CR"},{"name":"Raghav Awasthi","title":"VP Marketing"},{"name":"Jessica Zhou","title":"VP Technology"},{"name":"Chloe Lee","title":"VP Finance"},{"name":"Calista Budi","title":"CR Director"},{"name":"Harshit Sethi","title":"CR Director"},{"name":"Nevan Leo","title":"CR Executive"},{"name":"Ethan Le","title":"CR Executive"},{"name":"Sophia Huang","title":"CR Executive"},{"name":"Manya Garg","title":"CR Executive"},{"name":"Kai Wu","title":"CR Executive"},{"name":"Prashant Chopra","title":"Case Dev Executive"},{"name":"Lucas Ho","title":"Case Dev Executive"},{"name":"Ruhani Mittal","title":"Case Dev Executive"},{"name":"Arnav Dhablania","title":"Case Dev Executive"},{"name":"Aarav Alaric Bhatia","title":"Events Executive"},{"name":"Hannah Goharian","title":"Events Executive"},{"name":"Owen","title":"Events Executive"},{"name":"Leo Shang","title":"Marketing Executive"},{"name":"Jove Wan","title":"Marketing Executive"},{"name":"Divjot Virdi","title":"Marketing Executive"},{"name":"Anne Nguyen","title":"Marketing Executive"},{"name":"Felicia Amelia","title":"Marketing Executive"},{"name":"Harmanjeet Singh","title":"Developer"},{"name":"Chirag Raisingh","title":"Developer"},{"name":"Chloe Sepulveda","title":"Developer"},{"name":"Nicole Li","title":"Club Ops Executive"},{"name":"Jacob O'Callaghan","title":"Club Ops Executive"},{"name":"Andrew Andrew","title":"Finance Executive"},{"name":"Jenise Yang","title":"First Year Rep (Events)"},{"name":"Natania Huang","title":"First Year Rep (CR)"},{"name":"Julianna Huang","title":"First Year Rep"},{"name":"Carys Fong","title":"First Year Rep"},{"name":"Antarip Kashyap","title":"Advising Director"},{"name":"Bradley Wong","title":"Advising Director"},{"name":"Alexy Lamoot","title":"Advising Director"},{"name":"Kyle Gomez","title":"Advisor (Finance)"}]}});}),
...
const Team = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Team.useEffect": ()=>{
            const members = teamData.teams.flatMap({
                "Team.useEffect.members": (team)=>team.executives.map({
                        "Team.useEffect.members": (exec)=>({
                                name: exec.name,
                                title: exec.title,
                                profilepic: exec.profilepic
                            })
                    }["Team.useEffect.members"])
            }["Team.useEffect.members"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full py-20 md:py-24 bg-gradient-to-br from-[#f8f7f3] to-[#f0ede7] flex flex-col items-center overflow-hidden relative",
        id: "Team",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 mb-8 md:mb-12",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "font-inter text-sm font-normal text-gray-600 mb-2 lowercase italic",
                        children: "Team"
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            ...firstHalf
                                                ...
                                                className: "flex-shrink-0 flex flex-col items-center hover:-translate-y-2 transition-all duration-300 cursor-pointer group active:scale-95 active:-translate-y-1",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "relative",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: `w-20 h-20 rounded-full overflow-hidden border-2 border-gray-300 transition-opacity duration-300 ${loadedImages.has(index) ? "opacity-100" : "opacity-70"}`,
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProfileUrl"])(member.profilepic || 'default.webp'),
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-center mt-3 bg-white/20 backdrop-blur-md rounded-lg px-3 py-2 border border-white/30 shadow-lg group-hover:shadow-xl group-hover:shadow-purple-500/25 transition-all duration-300 group-active:shadow-lg group-active:shadow-purple-500/30 group-active:bg-white/30",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "font-inter text-black font-medium text-sm",
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "font-inter text-gray-700 text-xs",
                                            ...
                                            ...secondHalf
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "relative",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: `w-20 h-20 rounded-full overflow-hidden border-2 border-gray-300 transition-opacity duration-300 ${loadedImages.has(index + firstHalf.length) ? "opacity-100" : "opacity-70"}`,
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$assets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProfileUrl"])(member.profilepic || 'default.webp'),
                                                                alt: `${member.name} - ${member.title} at BOLT UBC`,
                                                                loading: "lazy",
...
//# sourceMappingURL=_83004602._.js.map